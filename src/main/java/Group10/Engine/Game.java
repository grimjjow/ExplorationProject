...
/**
 * The Game class which is the main part of the simulation.
 */
public class Game implements Runnable {
     ...
     * constructor
     *
     * @param gameMap The GameMap object generated by the Reader class on the map file.
     * @param queryIntent
     */
     ...
     *
     * @param gameMap The GameMap object generated by the Reader class on the map file.
     * @param agentFactory The MainFactory class use to create the agents.
     * @param queryIntent
     */
     ...
     * @throws IllegalFormatException If there is not enough space for the number of agent.
     */
     ...
     * @param safeRead
     * @throws IllegalArgumentException If both the queryIntent and the safeRead variables are false.
     */
    ...
    /**
     * Checks whether any of the teams fulfill their win conditions.
     *
     * @return The team that has won, otherwise null.
     */
    ...
    /**
     * Execute the given action on the given agent.
     *
     * @param agentContainer The agent that is going to execute the action.
     * @param action The action executed by the agent.
     * @return True if the action has been executed, otherwise false.
     */
    ...
    /**
     * Iterate over dynamic objects (sounds) and adjust lifetime or remove them.
     */
    ...
    /**
     * Generate the different perceptions for the given guard such as vision, sound, smell, area and scenario.
     *
     * @param guard The guard from which perceptions are generated.
     *
     * @return The guard perceptions.
     */
    ...
    /**
     * Generate the different perceptions for the given intruder such as target direction, vision, sound, smell, area and scenario.
     *
     * @param intruder The intruder from which perceptions are generated.
     *
     * @return The intruder perceptions.
     */
    ...
    /**
     * Compute the vision perception for the given agent.
     *
     * @param agentContainer The agent from which the vision is generated.
     *
     * @return The agent vision.
     */
    ...
    /**
     * Compute the area perception for the given agent.
     *
     * @param agentContainer The agent from which the area is generated.
     *
     * @return The agent area perception.
     */
    ...
    /**
     * Compute the sound perception for the given agent.
     *
     * @param agentContainer The agent from which the sound is generated.
     *
     * @return The agent sound perception.
     */
    ...
    /**
     * Compute the smell perception for the given agent.
     *
     * @param agentContainer The agent from which the smell is generated.
     *
     * @return The agent smell perception.
     */
