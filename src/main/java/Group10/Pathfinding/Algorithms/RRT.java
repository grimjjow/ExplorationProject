package Group10.Pathfinding.Algorithms;
...
public class RRT {
    ...
    public void generateGraph() {
        ...
        nodes.add(new GraphNode(new Point(x, y), 1.0, new Integer[]{(int)Math.ceil(x), (int)Math.ceil(y)}));
        ...
        while (true && counter > 0) {
            ...
            GraphNode newNode = new GraphNode(new Point(x, y), 1.0, new Integer[]{(int)Math.ceil(x), (int)Math.ceil(y)});
