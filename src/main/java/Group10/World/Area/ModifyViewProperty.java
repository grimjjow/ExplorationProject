...
public class ModifyViewProperty extends PropertyArea<Double> {

    private double guardModifier;
    private double intruderModifier;

    public ModifyViewProperty(AbstractObject parent, DataContainer dataContainer, double guardModifier, double intruderModifier) {
