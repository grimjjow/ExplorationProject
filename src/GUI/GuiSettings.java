...
public class GuiSettings {
    ...
    public static final double defaultHeight = 900;
    public static final double defaultWidth = 1450;
    ...
    public static final Color backgroundColor = Color.web("#282A37",1);
            //bright green
    public static final Color guardColor = Color.web("#7FFF00",1);
            //bright red
    public static final Color intruderColor = Color.web("#FF4500",1);
